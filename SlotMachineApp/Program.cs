            ...
            switch (gameInput)
            {
                ...
                case "2":
                    ...
                    else
                    {
                        ...
                        string result = SlotMachine2.DetermineWin(symbol1, symbol2, symbol3);

                        Console.WriteLine($"Jenis Kemenangan: {result}");

                        var balanceToAdd = new Dictionary<string, int>
        {
            { "Jackpot", 1000 },
            { "Mega Win", 300 },
            { "Super Win", 5000 },
            ...
            { "Lose", -500 }
                        ...
                        if (balanceToAdd.ContainsKey(result))
                        {
                            int balance = balanceToAdd[result];

                            Console.WriteLine($"Menambahkan {balance} ke akun.");
                            authService.AddBalance(currentUsername, balance);
                            
                        }
                        else
                        {
                            Console.WriteLine("Jenis kemenangan tidak dikenali.");
                        }
